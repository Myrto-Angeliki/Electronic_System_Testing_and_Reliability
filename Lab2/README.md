...
<br/>
<figure>
    <img src="/Lab2/doc/TRCUTwithLFSR_schematic.png" alt="TRCUTLFSR schematic" width="350" height="250">
...
<br/>
<figure>
    <img src="/Lab2/doc/TRCUTwithMISR_schematic.png" alt="TRCUTMISR schematic" width="450" height="550">
...
2. **Add source files**
<br/>
Add all .v files from the Lab1/src/ (besides *TRCUTtb.v*) and Lab2/src/ directory into your project.
...
signatures 1286 and 21785 are produced respectively. These signatures differ from the correct signature, meaning that the faults have been detected.<br>
